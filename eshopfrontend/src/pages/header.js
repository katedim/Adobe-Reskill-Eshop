...
<div className="flex items-center justify-between px-4 py-2 max-w-screen-xl mx-auto">
      <div className="flex items-center">
        ...
        <nav className="flex space-x-6">
          <a href="#" className="text-white font-semibold hover:underline">Category 1</a>
          <a href="#" className="text-white font-semibold hover:underline">Category 2</a>
          <a href="#" className="text-white font-semibold hover:underline">Category 3</a>
          <a href="#" className="text-white font-semibold hover:underline">Category 4</a>
          <a href="#" className="text-white font-semibold hover:underline">Category 5</a>
          <a href="#" className="text-white font-semibold hover:underline">Category 6</a>
        </nav>
      </div>
